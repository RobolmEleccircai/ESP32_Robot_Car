...
void MainWindow::on_pushButton_kd_raise_clicked()
{
    blueStates();
    socket->write(kd_raise.toLatin1());
}

void MainWindow::on_pushButton_kd_reduce_clicked()
{
    blueStates();
    socket->write(kd_reduce.toLatin1());
}

void MainWindow::on_pushButton_fornt_clicked()
{
    blueStates();
    socket->write(fornt.toLatin1());
}

void MainWindow::on_pushButton_kp_raise_clicked()
{
    blueStates();
    socket->write(kp_raise.toLatin1());
}

void MainWindow::on_pushButton_kp_reduce_clicked()
{
    blueStates();
    socket->write(kp_reduce.toLatin1());
}

void MainWindow::on_pushButton_ki_raise_clicked()
{
    blueStates();
    socket->write(ki_raise.toLatin1());
}

void MainWindow::on_pushButton_ki_reduce_clicked()
{
    blueStates();
    socket->write(ki_reduce.toLatin1());
}
